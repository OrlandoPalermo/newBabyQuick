...
namespace newBabyQuick.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        public ApplicationDbContext()
            : base("Data Source=213.246.49.103;Initial Catalog=rlandliv46751be15249_babyquick;User ID=rland_admin;Password=helha!7946132536;", throwIfV1Schema: false)
        {
        }
